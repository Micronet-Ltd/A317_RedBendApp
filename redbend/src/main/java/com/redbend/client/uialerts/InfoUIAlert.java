 ...
 * InfoUIAlert.java
 *
 * Displays an information message screen. The screen displays the message
 * DMA_VAR_UI_ALERT_TEXT and closes when the end-user taps OK or after
 * DMA_VAR_UI_ALERT_MAXDT seconds have passed.
 * 
 * Receives DIL events:
 * DMA_MSG_UI_ALERT if DMA_VAR_UI_ALERT_TYPE=DMA_UI_ALERT_TYPE_INFO (foreground only)
 *
 * Sends BL events:
 * DMA_MSG_USER_ACCEPT: if the end-user closes the message
