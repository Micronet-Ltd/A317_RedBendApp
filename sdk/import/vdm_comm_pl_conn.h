 ...
 *
 * vDirect Mobile uses event-driven communication, and supports both
 ...
 * Mobile Framework and passed to the communication component upon
 ...
 *
 * When initializing the raw communication, vDirect Mobile sends
