 ...
 * \file	vdm_pl_types.h
 *
 * \brief	vDirect Mobile Standard Types and Macros
 *
 * vDirect Mobile uses platform-independent versions of C built-in types and
...
#define _VDM_PL_TYPES_H_		//!< Internal
...
/*
 * Whether 64-bit integer is used.
 * By default, 64-bit systems use 64-bit integers.
 * Note: VDM_USE_I64 may be defined externally
 */
#ifdef VDM_X64
#define VDM_USE_I64
#endif
...
/*!
 * The following are standard vDirect Mobile types potentially requiring
 ...
 * to allow bit-wise operations on any vDirect Mobile type to be stored in an
...
#ifndef MAX_IU64
#define MAX_IU64	0xFFFFFFFFFFFFFFFF
#endif
