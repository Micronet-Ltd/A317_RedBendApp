 ...
 * flash memory.
 *
 * The vDirect Mobile framework requires that the download package be uniquely
 ...
 *
 * vDirect Mobile passes the URI node in the DM Tree of the download package as
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Client_PL_Dlpkg_create(UTF8CStr inURI,
	char **outDlpkgHandle);
 ...
 *
 * A package is normally downloaded in chunks. For each chunk, vDirect Mobile
 ...
 *
 * Before resuming a package download vDirect Mobile synchronizes between the
 ...
 *
 * When the package is fully downloaded, vDirect Mobile notifies the DM Client
 * application for processing. Once the update is complete, the DM Client
 * application can remove the package. vDirect Mobile will always try to remove
 ...
 * package, vDirect Mobile verifies that there is enough storage space for it.
 *
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Client_PL_Dlpkg_getMaxSize(IU32 *outDlpkgMaxSize);
