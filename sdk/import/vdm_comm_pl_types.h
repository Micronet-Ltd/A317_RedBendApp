 ...
 *
 * The Comm Observer is a structure of callback pointers created by the vDirect
 * Mobile Engine and passed to the communication component upon initialization.
...
/*!
 * When initializing the raw communication component, vDirect Mobile sends
...
typedef struct
{
	...
	UTF8CStr	userAgent;						/**< Value of User-Agent HTTP header */
	E_VDM_Comm_HttpAuthLevel_t proxyAuthLevel;	/**< Proxy server authentication level.
													 A value from \ref E_VDM_Comm_HttpAuthLevel_t */
	UTF8Str		proxyUsernamePassword;			/**< B64 encoded User name and password for proxy authentication */
