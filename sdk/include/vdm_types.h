...
typedef struct {
	...
	UTF8Str strField[E_VDM_DDField_count];
...
typedef struct {
	UTF8Str version;
	char *uiInfo;
	IU32 totalSize;                     /*!< The total number of bytes to be downloaded from all URI in dd */
 ...
 *******************************************************************************
 */
typedef VDM_Error (*getMaxSizeCB_t)(IU32 *outMaxSize);
