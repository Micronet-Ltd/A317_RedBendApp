...
VDM_Error VDM_UTL_PersistentData_init(VDM_UTL_PersistentData_t **outDataHandle,
	const char *inRoot, const char *inKey);
 ...
 *
 * \param	inOldVersion		The old OMA DM Protocol Engine version
 * \param	inCurrentVersion	The new OMA DM Protocol Engine version
