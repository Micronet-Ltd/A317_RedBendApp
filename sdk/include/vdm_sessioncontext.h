 ...
 * by vDirect Mobile after all observers have been notified that a session has
 ...
 *			context must be set to NULL so that vDirect Mobile does not try to
 ...
 *******************************************************************************
 */
extern VDM_SessionContext_t* VDM_createSessionContext(UTF8CStr inInitiatorId, void* inData);
