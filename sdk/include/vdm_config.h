...
/*!
 *******************************************************************************
 * Get the timeout parameter for the time to wait for completion of report
 * sending over the network before writing report to usb.
 *
 * \return	The timeout in seconds
 *******************************************************************************
 */
#define VDM_Config_getWaitForUsbReportTimeoutSeconds() VDM_Config_getIU32("wait_for_usb_report_timeout_seconds")
 ...
 *******************************************************************************
 */
VDM_Error VDM_Config_declareTreeCtrl(const char *inKey, UTF8CStr inUri);
