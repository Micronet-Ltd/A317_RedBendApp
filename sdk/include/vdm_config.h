...
typedef enum {
	...
	E_VDM_DM_Server_bb = 4,		//!< BlackBerry Automotive
...
/*!
 *******************************************************************************
 * Set the maximum number of retry attempts that vDirect Mobile will make to
...
/*!
 *******************************************************************************
 * Get the maximum number of retry attempts that vDirect Mobile will make to
 * reconnect after non-fatal network failures before terminating the
 * connection.
 *
...
/*!
 *******************************************************************************
 * Set whether to use the Verizon Wireless specific tree structure.
 *  
 * Call after \ref VDM_create and before \ref VDM_start.
 *
 * \see		VDM_Config_getUseVzwTreeStructure
 *
 * \return	VDM_ERR_OK on success, or
 *			VDM_ERR_OUT_OF_SYNC if called after \ref VDM_start
 *******************************************************************************
 */
#define VDM_Config_setUseVzwTreeStructure() \
	VDM_Config_setEnum("dmserver", E_VDM_DM_Server_vzw)

/*!
 *******************************************************************************
 * Get whether using the Verizon Wireless specific tree structure.
 *
 * \see		VDM_Config_setUseVzwTreeStructure
 *
 * \return	TRUE if using the Verizon Wireless specific tree structure,
 *          FALSE otherwise
 *******************************************************************************
 */
#define VDM_Config_getUseVzwTreeStructure() \
	(E_VDM_DM_Server_vzw==VDM_Config_getEnum("dmserver"))
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Config_setOMADLUserAgentName(UTF8CStr inOMADLuserAgentName);
 ...
 *******************************************************************************
 */
extern UTF8CStr VDM_Config_getOMADLUserAgentName(void);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Config_setOMADMUserAgentName(UTF8CStr inOMADMuserAgentName);
 ...
 *******************************************************************************
 */
extern UTF8CStr VDM_Config_getOMADMUserAgentName(void);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Config_setDMProxy(UTF8CStr inProxy);
 ...
 *******************************************************************************
 */
extern UTF8CStr VDM_Config_getDMProxy(void);
 ...
 *			information is never used by the vDirect Mobile Engine. This
 *			information must be used when using the vDirect Mobile HTTP Stack
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Config_setDLProxy(UTF8CStr inProxy);
 ...
 *******************************************************************************
 */
extern UTF8CStr VDM_Config_getDLProxy(void);
 ...
 *			and used by the vDirect Mobile engine and is not passed to the
 *			Porting Layer.
 *
 * \param	inAuthLevel		HTTP authentication level, an
 *							\ref E_VDM_HttpAuthLevel_t value
...
/*!
 *******************************************************************************
 * Get whether vDirect Mobile is set to abort the session with
...
/*!
 *******************************************************************************
 * Enable or disable TNDS support. If disabled, vDirect Mobile responds with
 ...
 * compatibility with older versions of vDirect Mobile (before 04.05.01).
 *
 * Call after \ref VDM_create and before \ref VDM_start.
 *
 ...
 *
 * \note	This configuration does not affect behavior of vDirect Mobile
 ...
 *******************************************************************************
 */
extern IBOOL VDM_Config_setValue(char *key, char *value, VDM_Error *err);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Config_setStr(char *key, char *value);
 ...
 *******************************************************************************
 */
extern char *VDM_Config_getStr(char *key);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Config_setIBool(char *key, IBOOL value);
 ...
 *******************************************************************************
 */
extern IBOOL VDM_Config_getIBool(char *key);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Config_setIU32(char *key, IU32 value);
 ...
 *******************************************************************************
 */
extern IU32 VDM_Config_getIU32(char *key);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Config_setEnum(char *key, IU32 value);
 ...
 *******************************************************************************
 */
extern IU32 VDM_Config_getEnum(char *key);
 ...
 *******************************************************************************
 */
extern void VDM_Config_usage(char *inGroup, char *inTitle, IBOOL inPrintGroupPrefix);
 ...
 *******************************************************************************
 */
#define VDM_Config_getDMAccRoot() ((UTF8CStr)VDM_Config_getStr("12accountroot"))
...
VDM_Error VDM_Config_add(char *group, char *key, configType_t configType,
	IU32 flags, char *usage, char *defaultValue, lookupTable_t *lookupTable,
	char *altKey,
