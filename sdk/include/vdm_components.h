 ...
 *
 * \brief	Enumeration of all vDirect Mobile SDK Components
 *
 * When adding a new component to vDirect Mobile, add an enum value.
 *******************************************************************************
 */
...
BEGIN_ENUM(E_VDM_COMPONENT_TYPE)
	...
	DECL_ENUM_ELEMENT_STR(E_VDM_COMPONENT_WIMAX, "WiMAX")			///< WiMAX component
	DECL_ENUM_ELEMENT_STR(E_VDM_COMPONENT_DS, "DS")					///< DS extension
	...
	DECL_ENUM_ELEMENT_STR(E_VDM_COMPONENT_UDP, "UDP")				///< UDP Listener extension
	DECL_ENUM_ELEMENT_STR(E_VDM_COMPONENT_WIB, "WIB")				///< WIB extension
