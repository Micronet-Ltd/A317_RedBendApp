 ...
 *******************************************************************************
 */
extern IU32 VDM_UTL_getCurrentTimeInMillisec(TIME_T *outMillis);
...
/*!
 *******************************************************************************
 * Get the current time + UTC offset in milliseconds.
 *
 * \param  outMillis	Current local time in milliseconds with UTC offset
 *
 * \return  0 on success, positive number on failure
 *******************************************************************************
 */
extern IU32 VDM_UTL_getTimeInMillisWithoutUTCOffset(TIME_T *outMillis);
