 ...
 *
 * Functions to start and stop vDirect Mobile, as well as manage sessions,
...
/*!
 *******************************************************************************
 * Create and initialize the vDirect Mobile Engine.
 *
 * Once the vDirect Mobile Engine has been created and initialized it may be
...
/*!
 *******************************************************************************
 * Start the vDirect Mobile Engine.
 *
 * Call this function before calling any other vDirect Mobile function. If the
 * function returns an error, don't call any other vDirect Mobile function
...
/*!
 *******************************************************************************
 * Stop the vDirect Mobile Engine.
 *
 * \return	None
 *******************************************************************************
 */
...
/*!
 *******************************************************************************
 * Destroy the vDirect Mobile Engine.
 *
 ...
 *			VDM_ERR_INVALID_CALL if vDirect Mobile is not initialized yet
 *******************************************************************************
 */
 ...
 *******************************************************************************
 */
extern UTF8CStr VDM_getCurrentAccount(void);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_getDefaultAccount(IU8 *outDmAccPath, IU32 inMaxBufLen);
...
extern VDM_Error VDM_triggerAbortReportSession(
	UTF8CStr				inAccount,
	UTF8CStr				inAbortSessionAlertType,
	VDM_SessionContext_t*	inSessionContext);
/*!
 *******************************************************************************
 ...
 * to vDirect Mobile in the \a inCreateGenAlertsFunc callback. The content 
 ...
 *
 * The busy reference counter is useful when you want vDirect Mobile not to
...
/*!
 *******************************************************************************
 * Get vDirect Mobile version.
 *
 * \return	vDirect Mobile version string
 *******************************************************************************
 */

extern UTF8CStr VDM_getVersion(void);
...
/*!
 *******************************************************************************
 * Dump internal data of vDirect Mobile Core (trigger queue, threshold, etc).
 *
 ...
 * internal vDirect Mobile memory debug features.
 *
