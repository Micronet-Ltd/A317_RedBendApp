...
#define VDM_CONST_binFormat     (UTF8Str)"bin"
#define VDM_CONST_chrFormat     (UTF8Str)"chr"
#define VDM_CONST_intFormat     (UTF8Str)"int"
#define VDM_CONST_boolFormat    (UTF8Str)"bool"
 ...
 *******************************************************************************
 */
typedef IU16 (*VDM_Tree_PreCmdNotify_t)(UTF8CStr inURI, void *inContext);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Tree_getStringValueAcl(int isAcl, char *inServer, UTF8CStr inURI,
	IU8 *outBuffer, IU32 *ioLength);
 ...
 *******************************************************************************
 */
extern UTF8Str VDM_Tree_getStringValueDup(UTF8CStr inURI, VDM_Error *outResult);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Tree_getSubtreeChecksum(UTF8CStr inURI, IU8 *outBuffer,
	IU32 *ioLength);

/*!
 * DEPRECATED. Use VDM_Tree_replaceStringValueAcl instead.
 */
extern VDM_Error VDM_Tree_replaceStringValue(UTF8CStr inURI, UTF8Str inValue);
...
extern VDM_Error VDM_Tree_replaceStringValueAcl(int isAcl, char *inServer,
	UTF8CStr inURI, UTF8Str inValue);
 ...
 */
extern VDM_Error VDM_Tree_replaceIntValue(UTF8CStr inURI, IS32 inValue);
...
extern VDM_Error VDM_Tree_replaceIntValueAcl(int isAcl, char *inServer,
	UTF8CStr inURI, IS32 inValue);

/*!
 * DEPRECATED. Use VDM_Tree_getUintValueAcl instead.
 */
extern VDM_Error VDM_Tree_getUintValue(UTF8CStr inURI, IU32 *outValue);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Tree_getUintValueAcl(int isAcl, char *inServer, UTF8CStr inURI,
	IU32 *outValue);

/*!
 * DEPRECATED. Use VDM_Tree_replaceUintValueAcl instead.
 */
extern VDM_Error VDM_Tree_replaceUintValue(UTF8CStr inURI, IU32 inValue);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Tree_replaceUintValueAcl(int isAcl, char *inServer, UTF8CStr inURI,
	IU32 inValue);
 ...
 */
extern VDM_Error VDM_Tree_replaceBoolValue(UTF8CStr inURI, IBOOL inValue);
 ...
 */
extern VDM_Error VDM_Tree_replaceBinValue(UTF8CStr inURI, void *inValue, IU32 inLength);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Tree_replaceBinValueAcl(int isAcl, char *inServer, UTF8CStr inURI,
 ...
 *******************************************************************************
 */
VDM_Error VDM_Tree_addInteriorNodeEx(UTF8CStr inNodePath, UTF8CStr inType,
	UTF8CStr inAcl, IS8 inAccessType);
 ...
 *******************************************************************************
 */
VDM_Error VDM_Tree_deleteNode(UTF8CStr inNodePath);
...
typedef VDM_Error (*VDM_Tree_WriteExternalCB) (void *inContext, IU32 inOffset,
	const void *inData, IU32 inDataLen,
	IU32 inTotalSize);
/*!
 *******************************************************************************
 ...
 *******************************************************************************
 */
void *VDM_Tree_getExternalStorageContext(UTF8CStr inURI);
 ...
 *******************************************************************************
 */
UTF8Str VDM_Tree_getExternalNodeURIDup(void);
 ...
 *******************************************************************************
 */
typedef VDM_Error (*VDM_Tree_DeleteFunc) (void *inContext, UTF8CStr inURI);
...
typedef VDM_Error (*VDM_Tree_AddFunc) (void *inContext, const void *inData,
	IU32 inOffset, IU32 inDataLen, IU32 inTotalSize, UTF8CStr inFormat,
	UTF8CStr inURI, IS8 *outDFFlags, E_VDM_Tree_AddNotifyCB_operationPhase_t inPhase);
 ...
 */
extern VDM_Error VDM_Tree_getProperty(UTF8CStr inURI, UTF8CStr inPropertyName,
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Tree_getPropertyAcl(int isAcl, char *inServer, UTF8CStr inURI,
	UTF8CStr inPropertyName, void *outBuffer, IU32 *ioLength);
 ...
 *******************************************************************************
 */
extern IBOOL VDM_Tree_nodeExists(UTF8CStr inUri);
 ...
 *******************************************************************************
 */
typedef void (*VDM_Tree_ReplaceAclNotifyCB) (UTF8CStr inURI, UTF8CStr inNewAcl);
 ...
 *******************************************************************************
 */
VDM_Error VDM_Tree_registerReplace(UTF8CStr inURI,
