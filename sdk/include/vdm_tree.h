 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Tree_replaceStringValue(
	UTF8CStr	inURI, 
	UTF8Str		inValue);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Tree_replaceIntValue(
	UTF8CStr	inURI, 
	IS32		inValue);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Tree_getUintValue(
	UTF8CStr	inURI, 
	IU32*		outValue);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Tree_replaceUintValue(
	UTF8CStr	inURI, 
	IU32		inValue);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Tree_replaceBoolValue(
	UTF8CStr	inURI, 
	IBOOL		inValue);
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Tree_replaceBinValue(
	UTF8CStr	inURI, 
	void*		inValue,
	IU32		inLength);
 ...
 * \param	inBufSize	The size of \a outBuffer, in bytes. This may
 *						be 0, in which case only the total length of the data
 *						is returned.
 * \param	outDataLen	The total length of the entire data in bytes.
 *
 ...
 * then vDirect Mobile will normally try to set the length of the data to 0,
 ...
 * 			allocated by vDirect Mobile and should be freed by the caller
 ...
 *******************************************************************************
 */
extern VDM_Error VDM_Tree_getProperty(
	UTF8CStr	inURI,
