 ...
 *******************************************************************************
 */
extern VDM_Error VDM_UTL_CfgParser_parseFile(void *inContext, char *inFileName,
	VDM_UTL_CfgParser_configPairCB inConfigurationFunc);
 ...
 *							string for \a inKey. The size of the buffer must be 
 *							VDM_UTL_CFGPARSER_KEY_VAL_PRINTOUT_LEN + 1
 * \param	inVal			The string that contains the value 
 * \param	outValPrintout	The buffer that will contain the formatted printout
 *							string for \a inVal. The size of the buffer must be 
 *							VDM_UTL_CFGPARSER_KEY_VAL_PRINTOUT_LEN + 1
 *
 * \return	none
 *******************************************************************************
...
extern void VDM_UTL_CfgParser_getFormattedPrintout(
    UTF8CStr inKey,
    UTF8Str outKeyPrintout,
    UTF8CStr inVal,
    UTF8Str outValPrintout);
