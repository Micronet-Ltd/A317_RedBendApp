...
#if defined(VDM_COMPONENT_ID_E_VDM_COMPONENT_WIMAX) && defined(LOG_WIMAX)
#undef LOG_IN_RLS
#define LOG_IN_RLS
#endif
...
#if defined(VDM_COMPONENT_ID_E_VDM_COMPONENT_UDP) && defined(LOG_UDP)
#undef LOG_IN_RLS
#define LOG_IN_RLS
#endif
	
#if defined(VDM_COMPONENT_ID_E_VDM_COMPONENT_WIB) && defined(LOG_WIB)
#undef LOG_IN_RLS
#define LOG_IN_RLS
#endif
