 ...
 * GcmHandler.java
 *
 * Parses GCM notification and, if required, sends a request for registration to
 * GcmReceiver. Implemented in RBGcmHandler.java.
 * 
 * Receives DIL events;
 * DMA_MSG_GCM_REGISTRATION_DATA
 * DMA_MSG_GCM_UN_REGISTRATION_DATA
 *
