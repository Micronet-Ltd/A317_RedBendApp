 ...
 * DilActivity.java
 *
 * Common logic for every Android Activity that is displayed as a result of a
 * DIL event.
 *
...
abstract public class DilActivity extends Activity 
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent i = getIntent();
		Log.d(LOG_TAG,"intent: " + i.toString() + "serviceName: " + i.getStringExtra(serviceName));
		try {
		...
		//add RB icon for Android Lollipop material theme.
		ActionBar ab = getActionBar();
		if (null != ab){
			ab.setDisplayHomeAsUpEnabled(false);
	        ab.setHomeButtonEnabled(true);
	        ab.setIcon(R.drawable.action_bar_logo);
